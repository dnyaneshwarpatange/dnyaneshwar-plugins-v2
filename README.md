...
For your app credentials like MONGO_URL, put them in a .env file on the VPS:

MONGO_URL=mongodb://... OTHER_SECRET=...

docker run -d
--name atlassian-checker
--restart always
-p 80:3000
--env-file .env
-e XDG_CONFIG_HOME=/tmp/.chromium
-e XDG_CACHE_HOME=/tmp/.chromium
-e CHROME_CRASHPAD_DATABASE=/tmp/.chromium/Crashpad
dnyaneshwarpatange/atlassian-checker:latest
